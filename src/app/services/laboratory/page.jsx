  ...
  const restContent = (
    <>
      ...
      <ul className="list-disc list-outside pl-4 text-gray-700 leading-relaxed">
        <li>
          <b>Bloodwork (Various Types):</b> Blood tests are foundational to veterinary diagnostics, offering vital information about your pet’s organ function, blood count, and health status. From routine screenings to complex diagnostics, our lab handles it all.
        </li>
        <li>
          <b>Urinalysis:</b> This test provides essential insights into your pet’s urinary tract health and overall well-being, helping to diagnose kidney issues, urinary tract infections, and more.
        </li>
        <li>
          <b>Fecal Analysis:</b> Regular fecal exams are crucial for detecting intestinal parasites that can affect your pet’s health and can be transmitted to humans. These tests are a key part of our preventive care strategy.
        </li>
        <li>
      ...
      <br />
      <h3 className="text-2xl font-semibold text-secondary mb-2">
        The Montrose Advantage: Why you should trust us with your pet's diagnostic needs
      </h3>
      <ul className="list-disc list-outside pl-4 text-gray-700 leading-relaxed">
        <li className="pl-2">
        ...
        <li>
          <b>Comprehensive Diagnostics:</b> From routine check-ups to emergency diagnostics, our lab is equipped to handle a wide range of testing needs, providing a one-stop solution for your pet’s health care requirements.
        </li>
        <li>
          <b>Communication and Care:</b> We believe in transparent communication with pet owners. Our team explains test results and treatment options clearly, ensuring you’re fully informed about your pet’s health care decisions.
        </li>
      </ul>
      <br />
      <h3 className="text-2xl font-semibold text-secondary mb-2">
      ...
      <p>
        Early detection through routine laboratory testing is pivotal in preventive veterinary care. By identifying issues before they become serious, we can often treat conditions more effectively and with less impact on your pet’s quality of life. Regular lab work also helps us monitor ongoing conditions and adjust treatments as needed, ensuring the best possible outcomes.
      </p>
      <br />
      <h3 className="text-2xl font-semibold text-secondary mb-2">Conclusion</h3>
      <p>
        At Montrose Pet Clinic, our comprehensive laboratory services are a cornerstone of the high-quality care we provide to every pet. By leveraging advanced diagnostics, we can uncover hidden health issues, tailor treatments precisely, and monitor your pet’s health with unmatched accuracy. Whether it’s a routine check-up or an urgent health concern, trust Montrose Pet Clinic to deliver the diagnostic excellence your pet deserves. Reach out to us today to learn more about our laboratory services or to schedule an appointment for your pet.
      </p>
    </>
  );
