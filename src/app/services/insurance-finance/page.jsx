...
const InsuranceFinance = () => {
  const firstSection = {
    ...
    text: "We use a third-party platform to help you in financing needs of your pet care. They provide simple, friendly payment plans for your immediate and unexpected needs. The application process took only 90 seconds and finding a plan won’t affect your credit score. Plans range from $35 - $10,000 with no deferred interest, or prepayment penalties.",
  };
  ...
  const restContent = (
    <>
      ...
      <h3 className="text-2xl font-semibold text-secondary mb-2">How it works?</h3>
      <p className="text-gray-700 leading-relaxed mb-4">
        Find a plan at scratchpay.com. When approved the clinic will be notified. The clinic will take further actions to get the fund from scratch plan to use towards your pet’s medical care. Split upfront treatment costs into manageable monthly or bi-weekly payments.
      </p>
