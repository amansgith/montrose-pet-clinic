  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <ul className="list-disc list-outside pl-4 text-gray-700 leading-relaxed mb-4">
        ...
        <li><b>Vaccinations:</b> Protect your pets from common diseases with our up-to-date vaccination services. We follow the latest guidelines to ensure your pet&rsquo;s safety.</li>
        <li><b>Dental Care:</b> Oral health is crucial for your pet&rsquo;s overall well-being. Our dental services help prevent problems like gum disease and tooth decay.</li>
      ...
      <ul className="list-disc list-outside pl-4 text-gray-700 leading-relaxed mb-4">
        ...
        <li><b>State-of-the-Art Facility:</b> We&rsquo;ve equipped our clinic with the latest technology to ensure accurate diagnoses and effective treatments.</li>
      ...
      <p className="text-gray-700 leading-relaxed mb-6">
        We believe that every pet deserves the best care, and we&rsquo;re here to provide it. Whether you&rsquo;re a new pet owner or a long-time animal lover, Montrose Pet Clinic is your partner in keeping your pets happy and healthy.
      </p>
      <p className="text-gray-700 leading-relaxed mb-6">
        Give us a call today to schedule an appointment, or stop by to meet our friendly team and tour our facility. We can&rsquo;t wait to welcome you and your furry friends to the Montrose Pet Clinic family!
      </p>
