      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <fieldset className="border border-gray-300 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <select name="animal1" className="input-field" onChange={handleChange} required>
              <option value="animal1">Animal 1</option>
              <option value="Dog">Dog</option>
              <option value="Cat">Cat</option>
              <option value="Other">Other</option>
            </select>
            <input type="text" name="animal1Breed" placeholder="Breed of animal 1" className="input-field" onChange={handleChange} required />
            <select name="animal1Sex" className="input-field" onChange={handleChange} required>
            ...
            <div>
              ...
              <input type="date" name="animal1dob" className="input-field" onChange={handleChange} required max={today} min={twentyYearsAgo} />
            </div>
          </div>

          {/* Animal 2 */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <select name="animal2" className="input-field" onChange={handleChange}>
              <option value="GenderofAnimal1">Gender of Animal 2</option>
              <option value="Dog">Dog</option>
              <option value="Cat">Cat</option>
              <option value="Other">Other</option>
            </select>
            <input type="text" name="animal2Breed" placeholder="Breed of Animal 2" className="input-field" onChange={handleChange} />
            <select name="animal2Sex" className="input-field" onChange={handleChange}>
              <option value="M">Male</option>
              <option value="F">Female</option>
            </select>
            <div>
              <label htmlFor="animal2Age" className="block text-gray-500 pl-2">Animal 2 D.O.B</label>
              <input type="date" name="animal2Age" className="input-field" onChange={handleChange} max={today} min={twentyYearsAgo} />
            </div>
          </div>
        </fieldset>
        ...
        <fieldset className="border border-gray-300 p-4 rounded-lg">
          ...
          <select name="heardAboutUs" className="input-field" onChange={handleChange} required>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
            <div>
              ...
              <input type="date" name="appointmentDate" className="input-field" onChange={handleChange} required min={today} />
            </div>
            <div>
              <label htmlFor="appointmentTime" className="block text-gray-700">Time of Appointment</label>
              <input type="time" name="appointmentTime" className="input-field" onChange={handleChange} required />
            </div>
          </div>
