  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <h1 className="text-3xl font-bold text-primary mb-6">
        Safeguarding Your Pets&rsquo; Health: The Critical Role of Vaccinations
      </h1>
